...
> **Status**: In Progress (3/8 Complete — story-001 autoload skeleton ✅ + story-002 combat handlers ✅ + story-003 LRU eviction tests ✅ ; **AC-CMB-42 Combat-021 close-out cross-system résolu** — 22/22 PASS cumulé / 2.64 s 2026-05-09)
> **Stories**: 8 created 2026-05-04 (5 Logic + 2 Integration + 1 Visual/Feel ADVISORY) — 3 Complete + 5 Ready (story-004 next pickup flash events wall-clock + WCAG 333 ms guard body)
