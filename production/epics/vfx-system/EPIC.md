...
> **Status**: In Progress (5/8 Complete — autoload + combat + LRU + flash events + accessibility pull ✅ ; **AC-CMB-42 Combat-021 close-out + WCAG 2.3.1 compliance + ADR-0015 D-1 close-out cross-system VFX** — 34/34 PASS cumulé / 2.83 s 2026-05-09)
> **Stories**: 8 created 2026-05-04 (5 Logic + 2 Integration + 1 Visual/Feel ADVISORY) — 5 Complete + 3 Ready (story-006 next pickup GSM visibility state_changed gating — débloque AC-VFX-15 deferred story-004)
