...
> **Status**: In Progress (4/8 Complete — story-001 autoload + story-002 combat + story-003 LRU + story-004 flash events ✅ ; **AC-CMB-42 Combat-021 close-out cross-system résolu** + WCAG 2.3.1 compliance empirique vérifié burst 10/1s ≤ 3 flashs — 30/30 PASS cumulé / 2.69 s 2026-05-09)
> **Stories**: 8 created 2026-05-04 (5 Logic + 2 Integration + 1 Visual/Feel ADVISORY) — 4 Complete + 4 Ready (story-005 next pickup accessibility pull `reduce_flash`/`reduce_motion`/`flash_mult` ADR-0015 D-1 Option A)
...
| C6 | GSM visibility state_changed gating | [story-006 gsm-visibility-state-changed-gating](story-006-gsm-visibility-state-changed-gating.md) | Logic | Ready | AC-VFX-15/16/17 | Listener `state_changed` CONNECT_DEFERRED ; freeze MENU/PAUSED/BOSS_DEFEATED ; restoration PLAYING. R-VFX-12. |
