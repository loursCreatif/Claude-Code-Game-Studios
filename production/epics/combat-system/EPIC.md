...
| 020 | Swoosh fade-out wall-clock + multi-kill clac + ducking | Integration | ✅ Complete 2026-05-03 (MockAudioHandler contract-only — AC-CMB-51 + AC-CMB-audio-01 + AC-CMB-audio-02 ; 11/11 PASS) | Audio System GDD r2.2 + ADR-0009 Accepted (#11 backlog résolu) |
| 021 | VFX decal cap pool LRU contract | Integration | **Closed - Migrated to VFX System 2026-05-04** | AC-CMB-42 → AC-VFX-01/02/03/30 (R-VFX-4 LRU 32 ring buffer) — owned VFX Epic |
| 022 | Accessibility `reduce_motion` Combat impact | Logic | Ready (Polish P3) | ADR-0015 ✅ Accepted 2026-05-02 |

**Totaux** : 22 stories — 20 Complete (001..018 + 020 + 022) + 1 Ready (019 Gap 5 panel Martin pending) + 1 Closed-Migrated (021 → VFX Epic 2026-05-04). 2026-05-04 P2 unblock : Gap 2 résolu Variante B empirique (story-010 Complete sans code production, mitigation `_tick0_intersect_shape_overlap` redondante) + Gap 5 résolu protocol playtest publié (story-019 Ready, recrutement panel Martin reste). 2026-05-04 P3 close-out : story-017 microbench + story-018 soak intégration baseline Apple M4 (Tier 1 sign-off DEFERRED CI infra).
