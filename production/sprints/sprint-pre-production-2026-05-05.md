...
5. **Tier 1 hardware sign-off DEFERRED** (W-1+W-2 smoke-2026-05-04) — gates draw_calls + 60 fps full-stack baselines à exécuter sur Tier 1 minimum (i3-10100F + GTX 1050) avant Production.
6. **Story-018 (f) zero warnings stderr DEFERRED** — instrumentation framework GdUnit4 manquante.
7. **Story-019 Combat panel ≥5 testeurs × 3 sessions Martin** — protocol publié, recrutement pending (`production/qa/protocols/combat-feel-interview.md`).
